...
struct Snow : public App {
  ...
  virtual void initialize() override final {
    ...
    emitter =
        Emitter(world, make_material(S2_MATERIAL_TYPE_SNOW, 1000.0f, 1.0f, 0.2),
...
std::unique_ptr<App> create_app() { return std::unique_ptr<App>(new Snow); }
